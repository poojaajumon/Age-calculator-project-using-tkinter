...
if __name__ == "__main__" :
	...
	gui.geometry("525x400")

	# Create a Date Of Birth : label 
	dob = Label(gui, text = "Date Of Birth", fg = "red",bg="light yellow", font=30)

	# Create a Given Date : label
	givenDate = Label(gui, text = "Given Date", fg = "red",bg="light yellow", font=30)
	...
	clearAllEntry = Button(gui, text = "Clear All", fg = "Black", bg = "yellow", command = clearAll)
